...
APP_PORT=8080          # 应用端口
HEALTH_CHECK_URL=http://127.0.0.1:${APP_PORT}/devops-demo  # 应用健康检查URL
HEALTH_CHECK_FILE_DIR=/home/admin/status   # 脚本会在这个目录下生成nginx-status文件
APP_HOME=/home/admin/devops-demo  # 从package.tgz中解压出来的jar包放到这个目录下
WAR_NAME=devops-demo.war # jar包的名字
...
start_application() {
    ...
    cp /home/admin/devops-demo/devops-demo.war /usr/local/apache-tomcat/webapps/
